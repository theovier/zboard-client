		...
		<div class="flex h-full flex-col justify-between">
			<div class="space-y-4 text-sm">
				...
				<p class="line-clamp-4">
					...
					5 Jahre alt, 178cm groß, orange-schwarz gestreift. Er ist
					ganz lieb und zutraulich. Er war der Tiger in Hangover
					&#128526;. Er isst hauptsächlich nervige Menschen, die nicht
					anklopfen.
				</p>
			</div>
